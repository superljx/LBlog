package top.ljx.util.quartz;

import lombok.extern.slf4j.Slf4j;
import org.quartz.JobExecutionContext;
import org.springframework.scheduling.quartz.QuartzJobBean;
import top.ljx.entity.ScheduleJobLog;
import top.ljx.service.ScheduleJobService;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		top.ljx.entity.ScheduleJob scheduleJob = (top.ljx.entity.ScheduleJob) context.getMergedJobDataMap().get(top.ljx.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
