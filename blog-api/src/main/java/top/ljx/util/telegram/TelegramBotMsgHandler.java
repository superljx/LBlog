...
import top.ljx.config.properties.TelegramProperties;
import top.ljx.entity.Comment;
import top.ljx.entity.Moment;
import top.ljx.enums.CommentPageEnum;
import top.ljx.service.CommentService;
import top.ljx.service.MomentService;
...
public class TelegramBotMsgHandler {
	...
	private String replyComment(String msgContent) {
		...
		if (splitIndex2 != -1 && msgContent.length() > splitIndex2 + 1) {
			...
			top.ljx.model.dto.Comment comment = new top.ljx.model.dto.Comment();
